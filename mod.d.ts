...
/**
* Interface for adding two single-precision complex floating-point numbers.
*/
interface Add {
	/**
	...
	* var v = add.assign( 5.0, 3.0, 5.0, 3.0, out, 1, 0 );
	...
	*
	* var out = add.strided( z1, 1, 0, z2, 1, 0, new Float32Array( 2 ), 1, 0 );
	* // returns <Float32Array>[ 10.0, 6.0 ]
	*/
